<template>
  <main class="max-w-lg mx-auto flex-grow w-9/12">
    <div class="bg-gray-100 p-8 md:p-12 mt-10 mb-5 rounded-lg shadow-2xl flex-grow">
      <section>
        <h3 class="text-blue-900 text-3xl font-medium">Get a new password</h3>
      </section>
      ...
      <div v-if="successful"
        ...
        <div class="flex">
          ...
          <div>
            ...
            <p class="text-sm">Your reset link his on the way, please check it by going to your mailbox.</p>
      ...
      <section v-if="!successful" class="mt-10">
        ...
        <Form class="flex flex-col" @submit="handleForgot" :validation-schema="schema">
          ...
          <button :disabled="loading"
            ...
            <span>Redeem a password reset link</span>
          </button>
        </Form>
      </section>
    </div>
